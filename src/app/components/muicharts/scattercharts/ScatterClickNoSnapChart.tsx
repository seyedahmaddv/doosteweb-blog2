...
interface SeriesType {
    ...
    [key: string]: any; // Additional series properties if required
}

interface ItemType {
    dataIndex: number; // Index of the data item
    series: SeriesType; // Series information
}

interface DataType {
    axis?: AxisType; // Axis-related data
    item?: ItemType; // Selected data point
...
export default function ScatterClickNoSnapChart() {
    ...
    const { axis, item, ...other }: Partial<DataType> = data ?? {};
