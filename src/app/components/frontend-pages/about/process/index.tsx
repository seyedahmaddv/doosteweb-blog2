            ...
            <Container maxWidth="lg">
                <Grid container spacing={3} justifyContent="center">
                    <Grid
                        ...
                        }} fontWeight="700" mt={5}>ماموریت و چشم‌انداز</Typography>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={3} justifyContent="center">
                    <Typography variant="h4" sx={{
                        ...
                        ماموریت من این است که به کسب‌وکارها کمک کنم تا ایده‌هایشان را به
                        وب‌اپلیکیشن‌هایی سریع، پایدار و قابل توسعه تبدیل کنند؛ محصولاتی که
                        صرفاً «کار نکنند»، بلکه باعث رشد، اعتماد کاربران و افزایش فروش شوند.
                    </Typography>
                    <Typography variant="h4" sx={{
                        fontSize: {
                            lg: '18px',
                        ...
                        من به توسعه اصولی، تصمیم‌گیری فنی آگاهانه و ساخت محصول با دید بلندمدت
                        باور دارم؛ نه راه‌حل‌های عجولانه و موقتی.
                    </Typography>
                </Grid>
